    ...
    if (interaction.customId == "open-ticket") {
      ...
      interaction.guild.channels.create(`ticket-${interaction.user.username}`, {
        ...
        const embed = new client.discord.MessageEmbed()
          .setColor('303236')
          .setAuthor({name: `${interaction.user.username}'s Ticket`, iconURL: 'https://cdn.discordapp.com/avatars/875963722772910081/ebac243226e5d1c5791041634af59e57.webp?size=2048'})
          .setDescription('Select the category of your ticket')
          .setFooter({text: `${client.user.tag} || Ticket Moon` , iconURL: client.user.displayAvatarURL()})
          .setTimestamp();
        ...
        if (i.customId == 'confirm-close') {
          ...
          chan.edit({
            ...
            .then(async () => {
              const embed = new client.discord.MessageEmbed()
                .setColor('303236')
                .setAuthor({name: 'Ticket', iconURL: 'https://cdn.discordapp.com/avatars/875963722772910081/ebac243226e5d1c5791041634af59e57.webp?size=2048'})
    ...
    if (interaction.customId == "delete-ticket") {
      ...
      chan.messages.fetch().then(async (messages) => {
        ...
        var result = await paste.uploadContent(a, {uploadFormat: 'markdown'})
            const embed = new client.discord.MessageEmbed()
              .setAuthor({name: 'Ticket Logs', iconURL: 'https://cdn.discordapp.com/avatars/875963722772910081/ebac243226e5d1c5791041634af59e57.webp?size=2048'})
              .setDescription(`🎟️ Logs for ticket \`${chan.id}\` | created by <@!${chan.topic}> | closed by <@!${interaction.user.id}>\n\nLogs: [**Click here to see the logs**](${getPasteUrl(result)})`)
              .setColor('303236')
            ...
            const embed2 = new client.discord.MessageEmbed()
              .setAuthor({name: 'Ticket Logs', iconURL: 'https://cdn.discordapp.com/avatars/875963722772910081/ebac243226e5d1c5791041634af59e57.webp?size=2048'})
              .setDescription(`🎟️ Logs for ticket \`${chan.id}\`: [**Click here to see the logs**](${getPasteUrl(result)})`)
              .setColor('303236')
              .setFooter({text: "This log will be deleted in 24 hrs!"})
              .setTimestamp();
